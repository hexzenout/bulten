...
(function () {
  ...
  function v1103EnsureLedgerTestStyles() {
    ...
    style.textContent = `
      ...
      /* V1219: Bahis sheet daralırken sadece Maç / Kupon boşluğunu azalt; diğer kolonlar okunur kalır. */
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1057-ledger-excel-table tbody td:nth-child(3),
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1061-ledger-excel-table tbody td:nth-child(3){background:linear-gradient(180deg,#2b3038 0%,#20262d 100%)!important;color:#f1f5f9!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto td:nth-child(3) .v1063-ledger-value{color:#f1f5f9!important;text-shadow:0 1px 0 rgba(0,0,0,.42)!important;font-size:10.6px!important;letter-spacing:-.032em!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;}

      /* V1207: Kripto Coin hücrelerini koyu gri yap; çizgiler koyu temada okunaklı kalsın. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1057-ledger-excel-table th:nth-child(3),
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1061-ledger-excel-table th:nth-child(3),
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1057-ledger-excel-table td:nth-child(3),
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1061-ledger-excel-table td:nth-child(3){
        ...
        box-shadow:inset 0 1px 0 rgba(255,255,255,.075), inset 0 -1px 0 rgba(0,0,0,.42)!important;
      }
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1057-ledger-excel-table tbody td:nth-child(3),
      ...
      /* V1209: Kripto Coin hücreleri test/manuel/çıktı fark etmeksizin yan hücrelerle aynı okunaklı stile kilitlendi. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1057-ledger-excel-table tbody td:nth-child(3),
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto .v1061-ledger-excel-table tbody td:nth-child(3),
      .v1162-ledger-output-modal.crypto .v1054-daily-ledger.crypto .v1057-ledger-excel-table tbody td:nth-child(3),
      .v1162-ledger-output-modal.crypto .v1054-daily-ledger.crypto .v1061-ledger-excel-table tbody td:nth-child(3){
        background:#dbeafe!important;
        color:#071827!important;
        border-color:#0f172a!important;
        border-left:1px solid #0f172a!important;
      ...
      .v1162-ledger-output-modal.crypto .v1054-daily-ledger.crypto .v1061-ledger-excel-table tbody td:nth-child(3) .v1057-ledger-input{
        color:#071827!important;
        text-shadow:none!important;
      ...
      /* V1210: Bahis tarafında test butonları kripto gibi açılır menüye alındı; kripto alt/yan nefes boşlukları eşitlendi. */
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1103-ledger-test-toolbar.v1210-bet-test-toolbar .v1210-bet-test-toggle{
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1103-ledger-test-toolbar.v1210-bet-test-toolbar::after{content:""!important;position:absolute!important;left:0!important;top:22px!important;width:360px!important;max-width:calc(100vw - 24px)!important;height:10px!important;background:transparent!important;display:block!important;pointer-events:auto!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1103-ledger-test-toolbar.v1210-bet-test-toolbar:hover .v1210-bet-test-panel,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1103-ledger-test-toolbar.v1210-bet-test-toolbar:focus-within .v1210-bet-test-panel{display:grid!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1210-bet-test-panel strong{
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1210-bet-test-panel button{
        width:100%!important;
        height:26px!important;
        min-height:26px!important;
      ...
      /* V1222: Bahis ve kripto sağ/sol nefes payı ayrı ayrı final. Sol bozulmaz, sağ 4px genişletilir. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols]{--v1222-bet-sheet:524px;--v1222-bet-gap:8px;--v1222-bet-pad-left:6px;--v1222-bet-pad-right:10px;--v1222-bet-pad-bottom:6px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols="1"]{--v1222-bet-content:524px;--v1222-bet-modal:540px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols="2"]{--v1222-bet-content:1056px;--v1222-bet-modal:1072px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols="3"]{--v1222-bet-content:1588px;--v1222-bet-modal:1604px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols]{width:min(var(--v1222-bet-modal), calc(100vw - 10px))!important;min-width:min(var(--v1222-bet-modal), calc(100vw - 10px))!important;max-width:min(var(--v1222-bet-modal), calc(100vw - 10px))!important;margin-left:auto!important;margin-right:auto!important;box-sizing:border-box!important;overflow:hidden!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1056-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1060-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1065-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1056-ledger-screen-body,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-screen-body{width:min(var(--v1222-bet-modal), calc(100vw - 10px))!important;min-width:min(var(--v1222-bet-modal), calc(100vw - 10px))!important;max-width:min(var(--v1222-bet-modal), calc(100vw - 10px))!important;box-sizing:border-box!important;padding-left:var(--v1222-bet-pad-left)!important;padding-right:var(--v1222-bet-pad-right)!important;margin-left:0!important;margin-right:0!important;align-self:flex-start!important;overflow:visible!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1056-ledger-screen-body,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-screen-body{padding-top:0!important;padding-bottom:var(--v1222-bet-pad-bottom)!important;align-items:flex-start!important;overflow-x:hidden!important;overflow-y:auto!important;scrollbar-width:none!important;-ms-overflow-style:none!important;scrollbar-gutter:auto!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet{width:var(--v1222-bet-content)!important;min-width:var(--v1222-bet-content)!important;max-width:var(--v1222-bet-content)!important;margin-left:0!important;margin-right:0!important;align-self:flex-start!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-sheet-grid,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-sheet-grid{grid-template-columns:repeat(var(--v1110-ledger-cols,1), var(--v1222-bet-sheet))!important;width:var(--v1222-bet-content)!important;min-width:var(--v1222-bet-content)!important;max-width:var(--v1222-bet-content)!important;justify-content:start!important;align-items:start!important;gap:var(--v1222-bet-gap)!important;margin-left:0!important;margin-right:0!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-sheet,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-sheet,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1059-ledger-summary,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1060-ledger-summary-inline,
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-summary-blank,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-excel-table,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-excel-table{width:var(--v1222-bet-sheet)!important;min-width:var(--v1222-bet-sheet)!important;max-width:var(--v1222-bet-sheet)!important;box-sizing:border-box!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1057-ledger-excel-table th:nth-child(3),
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1057-ledger-excel-table td:nth-child(3){width:32.4%!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1078-ledger-match-text,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1069-ledger-match-name,
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols]{--v1222-crypto-sheet:518px;--v1222-crypto-gap:8px;--v1222-crypto-pad-left:6px;--v1222-crypto-pad-right:10px;--v1222-crypto-pad-bottom:6px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols="1"]{--v1222-crypto-content:518px;--v1222-crypto-modal:534px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols="2"]{--v1222-crypto-content:1044px;--v1222-crypto-modal:1060px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols="3"]{--v1222-crypto-content:1570px;--v1222-crypto-modal:1586px;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols]{width:min(var(--v1222-crypto-modal), calc(100vw - 10px))!important;min-width:min(var(--v1222-crypto-modal), calc(100vw - 10px))!important;max-width:min(var(--v1222-crypto-modal), calc(100vw - 10px))!important;box-sizing:border-box!important;overflow:hidden!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1056-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1057-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1060-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1065-ledger-screen-head,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1056-ledger-screen-body,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1057-ledger-screen-body{width:min(var(--v1222-crypto-modal), calc(100vw - 10px))!important;min-width:min(var(--v1222-crypto-modal), calc(100vw - 10px))!important;max-width:min(var(--v1222-crypto-modal), calc(100vw - 10px))!important;box-sizing:border-box!important;padding-left:var(--v1222-crypto-pad-left)!important;padding-right:var(--v1222-crypto-pad-right)!important;margin-left:0!important;margin-right:0!important;align-self:flex-start!important;overflow:visible!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1056-ledger-screen-body,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1057-ledger-screen-body{padding-bottom:var(--v1222-crypto-pad-bottom)!important;align-items:flex-start!important;overflow-x:hidden!important;overflow-y:auto!important;scrollbar-width:none!important;-ms-overflow-style:none!important;scrollbar-gutter:auto!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto{width:var(--v1222-crypto-content)!important;min-width:var(--v1222-crypto-content)!important;max-width:var(--v1222-crypto-content)!important;margin-left:0!important;margin-right:0!important;align-self:flex-start!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1057-ledger-sheet-grid,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1061-ledger-sheet-grid{grid-template-columns:repeat(var(--v1110-ledger-cols,1), var(--v1222-crypto-sheet))!important;width:var(--v1222-crypto-content)!important;min-width:var(--v1222-crypto-content)!important;max-width:var(--v1222-crypto-content)!important;justify-content:start!important;align-items:start!important;gap:var(--v1222-crypto-gap)!important;margin-left:0!important;margin-right:0!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1057-ledger-sheet,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1061-ledger-sheet,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1059-ledger-summary,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1060-ledger-summary-inline,
      ...
      /* V1224: Manuel büyük harf / uzun yazı hücreleri test stiliyle aynı kalsın; üst çizgiye yapışmasın ve yazılar net görünsün. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1057-ledger-excel-table,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1061-ledger-excel-table,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1063-ledger-value,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1060-ledger-cell-text,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1057-ledger-input,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1078-ledger-match-text,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1069-ledger-match-name,
      #v1056-ledger-screen-host .v1110-ledger-test-modal[data-v1110-ledger-cols] .v1076-ledger-match-odd,
      .v1162-ledger-output-modal .v1057-ledger-excel-table,
      .v1162-ledger-output-modal .v1061-ledger-excel-table,
      .v1162-ledger-output-modal .v1063-ledger-value,
      .v1162-ledger-output-modal .v1060-ledger-cell-text,
      .v1162-ledger-output-modal .v1057-ledger-input,
      .v1162-ledger-output-modal .v1078-ledger-match-text,
      .v1162-ledger-output-modal .v1069-ledger-match-name,
      .v1162-ledger-output-modal .v1076-ledger-match-odd{-webkit-font-smoothing:antialiased!important;text-rendering:optimizeLegibility!important;text-shadow:none!important;filter:none!important;}
      ...
      .v1162-ledger-output-modal.bet .v1063-ledger-value.v1069-ledger-item-lines.v1110-ledger-item-single{height:100%!important;min-height:0!important;max-height:100%!important;display:flex!important;align-items:center!important;justify-content:center!important;padding-top:0!important;padding-bottom:0!important;overflow:hidden!important;}
      ...
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1069-ledger-match-line{width:100%!important;max-width:100%!important;min-width:0!important;height:100%!important;display:inline-flex!important;align-items:center!important;justify-content:flex-start!important;column-gap:3px!important;overflow:hidden!important;line-height:1!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1078-ledger-match-text,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1078-ledger-match-text{display:inline-flex!important;align-items:center!important;min-width:0!important;max-width:100%!important;overflow:hidden!important;white-space:nowrap!important;line-height:1.04!important;font-style:normal!important;text-transform:none!important;letter-spacing:-.008em!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1069-ledger-match-name,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1069-ledger-match-name{display:inline-block!important;min-width:0!important;max-width:calc(100% - 33px)!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;vertical-align:middle!important;line-height:1.04!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10.5px!important;font-weight:950!important;font-style:normal!important;text-transform:none!important;color:#f8fafc!important;}
      ...
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1076-ledger-match-odd{flex:0 0 auto!important;display:inline-block!important;margin-left:3px!important;white-space:nowrap!important;line-height:1.04!important;font-size:10.5px!important;font-weight:1000!important;vertical-align:middle!important;}
      ...
      /* V1228: tüm manuel/test tekli yazılar aynı fontla, satır yüksekliğini büyütmeden dikey ortada kalsın. */
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1078-ledger-match-text,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1078-ledger-match-text{display:inline-flex!important;align-items:center!important;min-width:0!important;max-width:100%!important;overflow:hidden!important;white-space:nowrap!important;text-overflow:clip!important;line-height:1!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10.5px!important;font-weight:950!important;font-style:normal!important;text-transform:none!important;letter-spacing:0!important;color:#f8fafc!important;text-shadow:none!important;filter:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1069-ledger-match-name,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1069-ledger-match-name{display:inline-block!important;min-width:0!important;max-width:calc(100% - 34px)!important;overflow:hidden!important;text-overflow:clip!important;white-space:nowrap!important;vertical-align:middle!important;line-height:1!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10.5px!important;font-weight:950!important;font-style:normal!important;text-transform:none!important;letter-spacing:0!important;color:#f8fafc!important;text-shadow:none!important;filter:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1076-ledger-match-odd,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1076-ledger-match-odd{display:inline-block!important;flex:0 0 auto!important;margin-left:3px!important;white-space:nowrap!important;line-height:1!important;font-size:10.5px!important;font-weight:1000!important;vertical-align:middle!important;letter-spacing:0!important;color:#fbbf24!important;text-shadow:none!important;filter:none!important;}
      ...
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1112-ledger-soft-break{display:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto td:nth-child(3) .v1063-ledger-value,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.crypto[data-v1110-ledger-cols] .v1054-daily-ledger.crypto td:nth-child(3) .v1057-ledger-input,
      .v1162-ledger-output-modal.crypto .v1054-daily-ledger.crypto td:nth-child(3) .v1063-ledger-value,
      .v1162-ledger-output-modal.crypto .v1054-daily-ledger.crypto td:nth-child(3) .v1057-ledger-input{height:100%!important;min-height:0!important;max-height:100%!important;display:flex!important;align-items:center!important;justify-content:center!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10.55px!important;font-weight:950!important;font-style:normal!important;text-transform:none!important;letter-spacing:0!important;line-height:1!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;color:#f8fafc!important;-webkit-text-fill-color:#f8fafc!important;text-shadow:none!important;filter:none!important;background:transparent!important;}


      /* V1229: tekli manuel yazı tam metinden üretilir; satır yüksekliği büyümez, uzun metin 21px içinde iki kompakt satıra iner. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1069-ledger-match-line,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1069-ledger-match-line{height:21px!important;min-height:21px!important;max-height:21px!important;align-items:center!important;overflow:hidden!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1078-ledger-match-text,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1078-ledger-match-text{display:block!important;min-width:0!important;max-width:100%!important;overflow:hidden!important;white-space:normal!important;text-overflow:clip!important;line-height:.94!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10.35px!important;font-weight:950!important;font-style:normal!important;text-transform:none!important;letter-spacing:0!important;color:#f8fafc!important;text-shadow:none!important;filter:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1069-ledger-match-name,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1069-ledger-match-name{display:inline!important;min-width:0!important;max-width:none!important;overflow:visible!important;text-overflow:clip!important;white-space:normal!important;vertical-align:baseline!important;line-height:.94!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10.35px!important;font-weight:950!important;font-style:normal!important;text-transform:none!important;letter-spacing:0!important;color:#f8fafc!important;text-shadow:none!important;filter:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1076-ledger-match-odd,
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1076-ledger-match-odd{display:inline!important;flex:0 0 auto!important;margin-left:3px!important;white-space:nowrap!important;line-height:.94!important;font-size:10.35px!important;font-weight:1000!important;vertical-align:baseline!important;color:#fbbf24!important;text-shadow:none!important;filter:none!important;}
      ...
      .v1162-ledger-output-modal.bet .v1110-ledger-item-single .v1229-ledger-compact-break{display:block!important;content:""!important;height:0!important;line-height:0!important;margin:0!important;padding:0!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1110-ledger-item-single .v1112-ledger-soft-break,
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet .v1119-ledger-row-filler td,
      .v1162-ledger-output-modal.bet .v1119-ledger-row-filler,
      .v1162-ledger-output-modal.bet .v1119-ledger-row-filler td{display:none!important;height:0!important;min-height:0!important;max-height:0!important;padding:0!important;border:0!important;line-height:0!important;overflow:hidden!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet td:nth-child(4) .v1063-ledger-value{white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;font-size:9.6px!important;letter-spacing:-.01em!important;}


      /* V1235: 2/3 tablo ve çıktı tarafında kısa kolon altta boş kutu gibi uzamasın; satır yüksekliği/kolon genişliği değişmez. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet{height:auto!important;min-height:0!important;max-height:none!important;align-self:flex-start!important;overflow:visible!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-sheet-grid,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-sheet-grid,
      .v1162-ledger-output-modal.bet .v1057-ledger-sheet-grid,
      .v1162-ledger-output-modal.bet .v1061-ledger-sheet-grid{align-items:start!important;align-content:start!important;grid-auto-rows:max-content!important;height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-sheet,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-sheet,
      .v1162-ledger-output-modal.bet .v1057-ledger-sheet,
      .v1162-ledger-output-modal.bet .v1061-ledger-sheet{height:max-content!important;min-height:0!important;max-height:none!important;flex:0 0 auto!important;align-self:flex-start!important;overflow:visible!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-excel-table,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-excel-table,
      .v1162-ledger-output-modal.bet .v1057-ledger-excel-table,
      .v1162-ledger-output-modal.bet .v1061-ledger-excel-table{height:auto!important;min-height:0!important;max-height:none!important;flex:0 0 auto!important;align-self:flex-start!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1057-ledger-excel-table tbody,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1061-ledger-excel-table tbody,
      ...
      /* V1252: Maç/Kupon seçim ikonları iki satırlık yazı bloğunun tam görsel ortasına insin.
         Sadece ekrandaki BAHİS / KUPON DEFTERİ test modalını hedefler; popup/kolon/satır/kamera ölçüsü değişmez. */
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-combo .v1069-ledger-match-line,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-longcombo .v1069-ledger-match-line{display:flex!important;align-items:center!important;column-gap:2px!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-combo .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-longcombo .v1069-ledger-status-mark{position:relative!important;top:1.25px!important;transform:none!important;align-self:center!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-combo .v1069-ledger-match-line.win .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-longcombo .v1069-ledger-match-line.win .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-combo .v1069-ledger-match-line.loss .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-longcombo .v1069-ledger-match-line.loss .v1069-ledger-status-mark{top:1.35px!important;transform:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-combo .v1069-ledger-match-line.pending .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-longcombo .v1069-ledger-match-line.pending .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-combo .v1069-ledger-match-line.push .v1069-ledger-status-mark,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] tr.v1118-ledger-row-longcombo .v1069-ledger-match-line.push .v1069-ledger-status-mark,
      ...
      /* V1256: Maç/Kupon ikonları sabit X aksında, yazı bloğunun gerçek dikey merkezinde durur.
         Ana popup + kamera çıktısı aynı iç düzeni kullanır; kolon/popup/satır bölme mantığına dokunmaz. */
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-status-mark{position:relative!important;top:auto!important;left:auto!important;right:auto!important;bottom:auto!important;transform:none!important;align-self:center!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:0 0 10px!important;width:10px!important;min-width:10px!important;max-width:10px!important;height:12px!important;min-height:12px!important;max-height:12px!important;line-height:12px!important;margin:0!important;padding:0!important;font-family:Arial,Helvetica,sans-serif!important;font-size:11px!important;font-weight:1000!important;text-align:center!important;overflow:visible!important;background:none!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line.pending .v1069-ledger-status-mark,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line.push .v1069-ledger-status-mark,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line.open .v1069-ledger-status-mark{color:transparent!important;font-size:0!important;top:auto!important;transform:none!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line.pending .v1069-ledger-status-mark::before,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line.push .v1069-ledger-status-mark::before,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line.open .v1069-ledger-status-mark::before{content:""!important;display:block!important;width:8.5px!important;height:2.2px!important;border-radius:999px!important;background:#64748b!important;position:absolute!important;left:50%!important;top:50%!important;transform:translate(-50%,-50%)!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1076-ledger-match-odd{display:inline!important;line-height:1.02!important;vertical-align:baseline!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1076-ledger-match-odd,
      ...
      /* V1257: V1256 ikon merkezleme korunur; yazı taşması/harf değmesi engellenir.
         Sadece Maç/Kupon iç metin güvenli alanı; tablo/popup/kolon/satır bölme değişmez. */
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-item-lines{overflow:hidden!important;box-sizing:border-box!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1069-ledger-match-line,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-line{display:flex!important;align-items:center!important;justify-content:flex-start!important;column-gap:2px!important;gap:2px!important;width:auto!important;max-width:100%!important;margin:0!important;padding:0!important;line-height:1!important;overflow:hidden!important;box-sizing:border-box!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1078-ledger-match-text,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1078-ledger-match-text{display:block!important;flex:1 1 auto!important;min-width:0!important;max-width:calc(100% - 12px)!important;margin:0!important;padding:0!important;overflow:hidden!important;white-space:normal!important;text-overflow:clip!important;overflow-wrap:normal!important;word-break:normal!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:900!important;line-height:1!important;letter-spacing:0!important;text-align:left!important;box-sizing:border-box!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1069-ledger-match-name,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1076-ledger-match-odd,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1069-ledger-match-name,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet .v1076-ledger-match-odd{display:inline!important;line-height:1!important;vertical-align:baseline!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet tr.v1118-ledger-row-single .v1069-ledger-match-line{height:21px!important;min-height:21px!important;max-height:21px!important;overflow:hidden!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet tr.v1118-ledger-row-single .v1078-ledger-match-text{font-size:10.05px!important;line-height:0.99!important;max-height:20px!important;overflow:hidden!important;}
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet tr.v1118-ledger-row-single .v1076-ledger-match-odd{font-size:10.05px!important;line-height:0.99!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1118-ledger-row-combo .v1078-ledger-match-text,
      ...
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet tr.v1118-ledger-row-combo .v1078-ledger-match-text,
      .v1162-ledger-output-modal.bet .v1054-daily-ledger.bet tr.v1118-ledger-row-longcombo .v1078-ledger-match-text{line-height:1!important;overflow:hidden!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet .v1069-ledger-status-mark,
  ...
  function v1162PrepareOutputNode(node) {
    ...
    node.querySelectorAll(".v1162-ledger-output-modal.crypto .v1054-daily-ledger.crypto tbody td:nth-child(3), .v1054-daily-ledger.crypto tbody td:nth-child(3)").forEach(cell => {
      cell.style.setProperty("background", "#dbeafe", "important");
      cell.style.setProperty("color", "#071827", "important");
      cell.style.setProperty("border-color", "#0f172a", "important");
  ...
  async function v1162NodeToPngDataUrl(node) {
    ...
    try { await Promise.race([document.fonts?.ready || Promise.resolve(), new Promise(resolve => setTimeout(resolve, 300))]); } catch {}
    const rect = node.getBoundingClientRect();
  ...
  function v1163CleanupLedgerOutputStorage() {
    const cleanStore = (store) => {
      ...
      try {
        ...
        for (let i = 0; i < store.length; i += 1) {
          const k = store.key(i);
          if (k && k.startsWith("bulten_ledger_output_")) keys.push(k);
        }
  ...
  function v1163WriteLedgerOutputPayload(key, payload) {
    const raw = JSON.stringify(payload);
    v1163CleanupLedgerOutputStorage();
    try { localStorage.setItem(key, raw); return "l"; } catch {}
    try { sessionStorage.setItem(key, raw); return "s"; } catch {}
    return "";
  }
...
function escapeHtml(str) {
  ...
  function v1291ScheduleBetLedgerOpenStableLayout(root, mode){
    ...
    const run = () => {
      ...
      if (m === "bet") {
        ...
        try { v1295ApplyBetLedgerLongSingleFinalFix(scope); } catch(e) {}
      }
    };
    run();
  ...
  function v1293EnsureBetLedgerLongSingleSafeLayoutStyles(){
    const styleId = "v1293-bet-ledger-long-single-safe-layout";
    ...
    styleEl.textContent = `
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long td{height:auto!important;min-height:21px!important;max-height:none!important;vertical-align:middle!important;overflow:visible!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1063-ledger-value.v1069-ledger-item-lines.v1110-ledger-item-single{height:100%!important;min-height:23px!important;max-height:none!important;display:flex!important;align-items:center!important;justify-content:center!important;padding:1px 0!important;box-sizing:border-box!important;overflow:visible!important;text-align:left!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-match-line{height:auto!important;min-height:0!important;max-height:none!important;width:100%!important;max-width:100%!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;column-gap:2px!important;gap:2px!important;margin:0!important;padding:0!important;line-height:1.03!important;overflow:visible!important;box-sizing:border-box!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-status-mark{position:relative!important;top:0!important;left:0!important;right:auto!important;bottom:auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:0 0 10px!important;width:10px!important;min-width:10px!important;max-width:10px!important;height:11px!important;min-height:11px!important;max-height:11px!important;line-height:11px!important;margin:0!important;padding:0!important;font-family:Arial,Helvetica,sans-serif!important;font-size:11px!important;font-weight:1000!important;text-align:center!important;align-self:center!important;overflow:visible!important;background:none!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-match-line.win .v1069-ledger-status-mark{color:#10b981!important;transform:translateX(-1.15px)!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-match-line.loss .v1069-ledger-status-mark{color:#dc2626!important;transform:none!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1078-ledger-match-text{display:block!important;position:static!important;top:auto!important;flex:1 1 auto!important;min-width:0!important;width:auto!important;max-width:calc(100% - 12px)!important;height:auto!important;max-height:none!important;margin:0!important;padding:0 0 1px 0!important;overflow:visible!important;white-space:normal!important;text-overflow:clip!important;overflow-wrap:normal!important;word-break:normal!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10px!important;font-weight:950!important;line-height:1.04!important;letter-spacing:-.004em!important;color:#f8fafc!important;text-align:left!important;text-shadow:none!important;filter:none!important;box-sizing:border-box!important;}
      ...
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1076-ledger-match-odd{display:inline!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;vertical-align:baseline!important;line-height:1.04!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10px!important;font-weight:950!important;letter-spacing:-.004em!important;text-shadow:none!important;filter:none!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1076-ledger-match-odd{margin-left:3px!important;white-space:nowrap!important;font-weight:1000!important;color:#fbbf24!important;}
    `;
  ...
  function v1295EnsureBetLedgerLongSingleFinalStyles(){
    const styleId = "v1295-bet-ledger-long-single-final";
    let styleEl = document.getElementById(styleId);
    if (styleEl) return;
    styleEl = document.createElement("style");
    styleEl.id = styleId;
    styleEl.textContent = `
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long,
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long td{height:auto!important;min-height:28px!important;max-height:none!important;vertical-align:middle!important;overflow:visible!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1063-ledger-value.v1069-ledger-item-lines.v1110-ledger-item-single{height:auto!important;min-height:28px!important;max-height:none!important;display:flex!important;align-items:center!important;justify-content:center!important;padding:2px 0!important;margin:0!important;box-sizing:border-box!important;overflow:visible!important;text-align:left!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-match-line{height:auto!important;min-height:0!important;max-height:none!important;width:100%!important;max-width:100%!important;min-width:0!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;column-gap:2px!important;gap:2px!important;margin:0!important;padding:0!important;line-height:1.12!important;overflow:visible!important;box-sizing:border-box!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-status-mark{position:relative!important;top:0!important;left:0!important;right:auto!important;bottom:auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:0 0 11px!important;width:11px!important;min-width:11px!important;max-width:11px!important;height:12px!important;min-height:12px!important;max-height:12px!important;line-height:12px!important;margin:0!important;padding:0!important;font-family:Arial,Helvetica,sans-serif!important;font-size:11px!important;font-weight:1000!important;text-align:center!important;align-self:center!important;overflow:visible!important;background:none!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-match-line.win .v1069-ledger-status-mark{color:#10b981!important;transform:translateX(-2px)!important;}
      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1069-ledger-match-line.loss .v1069-ledger-status-mark{color:#dc2626!important;transform:none!important;}

      #v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long .v1078-ledger-match-text{display:block!important;position:static!important;top:auto!important;flex:1 1 auto!important;min-width:0!important;width:auto!important;max-width:calc(100% - 13px)!important;height:auto!important;min-height:0!important;max-height:none!important;margin:0!important;padding:1px 0 2px 0!important;overflow:visible!important;white-space:normal!important;text-overflow:clip!important;overflow-wrap:normal!important;word-break:normal!important;font-family:Arial,Helvetica,sans-serif!important;font-size:10px!important;font-weight:950!important;line-height:1.14!important;letter-spacing:-.004em!important;color:#f8fafc!important;text-align:left!important;text-shadow:none!important;filter:none!important;box-sizing:border-box!important;}
  ...
  function v1295ApplyBetLedgerLongSingleFinalFix(root){
    v1295EnsureBetLedgerLongSingleFinalStyles();
    const scope = root && root.querySelectorAll ? root : document;
    const rows = scope.querySelectorAll ? scope.querySelectorAll('#v1056-ledger-screen-host .v1110-ledger-test-modal.bet[data-v1110-ledger-cols] .v1054-daily-ledger.bet tr.v1232-ledger-row-single-long') : [];
    rows.forEach(row => {
      ...
      row.querySelectorAll('td').forEach(td => {
        ...
        td.style.setProperty('min-height','28px','important');
        td.style.setProperty('max-height','none','important');
        td.style.setProperty('overflow','visible','important');
        td.style.setProperty('vertical-align','middle','important');
      });
      const value = row.querySelector('.v1063-ledger-value.v1069-ledger-item-lines.v1110-ledger-item-single');
      if (value) {
        value.style.setProperty('height','auto','important');
        value.style.setProperty('min-height','28px','important');
        value.style.setProperty('max-height','none','important');
        ...
        value.style.setProperty('padding','2px 0','important');
        value.style.setProperty('overflow','visible','important');
      }
      const line = row.querySelector('.v1069-ledger-match-line');
      if (line) {
      ...
      const mark = row.querySelector('.v1069-ledger-status-mark');
      if (mark) {
        mark.style.setProperty('position','relative','important');
        mark.style.setProperty('top','0','important');
        mark.style.setProperty('left','0','important');
        mark.style.setProperty('display','inline-flex','important');
        mark.style.setProperty('align-items','center','important');
        mark.style.setProperty('justify-content','center','important');
        ...
        mark.style.setProperty('max-width','11px','important');
        mark.style.setProperty('height','12px','important');
        mark.style.setProperty('min-height','12px','important');
        mark.style.setProperty('max-height','12px','important');
        mark.style.setProperty('line-height','12px','important');
        mark.style.setProperty('margin','0','important');
        mark.style.setProperty('padding','0','important');
        mark.style.setProperty('font-size','11px','important');
        mark.style.setProperty('overflow','visible','important');
        if (line && line.classList.contains('win')) mark.style.setProperty('transform','translateX(-2px)','important');
        else if (line && line.classList.contains('loss')) mark.style.setProperty('transform','none','important');
      }
      row.querySelectorAll('.v1078-ledger-match-text').forEach(textEl => {
        textEl.style.setProperty('display','block','important');
        textEl.style.setProperty('position','static','important');
        textEl.style.setProperty('top','auto','important');
        textEl.style.setProperty('height','auto','important');
        textEl.style.setProperty('min-height','0','important');
        textEl.style.setProperty('max-height','none','important');
        textEl.style.setProperty('padding','1px 0 2px 0','important');
        textEl.style.setProperty('overflow','visible','important');
        textEl.style.setProperty('white-space','normal','important');
        textEl.style.setProperty('line-height','1.14','important');
      });
      row.querySelectorAll('.v1069-ledger-match-name, .v1076-ledger-match-odd').forEach(textEl => {
        textEl.style.setProperty('line-height','1.14','important');
        textEl.style.setProperty('overflow','visible','important');
        textEl.style.setProperty('vertical-align','baseline','important');
      });
    });
  }

  if(!window.__omegaV1295BetLedgerLongSingleFinalBound){
    window.__omegaV1295BetLedgerLongSingleFinalBound = true;
    const run = () => { try { v1295ApplyBetLedgerLongSingleFinalFix(document); } catch(e) {} };
    if(document.readyState === "loading") document.addEventListener("DOMContentLoaded", run, { once:true }); else run();
    try { requestAnimationFrame(() => requestAnimationFrame(run)); } catch(e) {}
    setTimeout(run, 80);
    setTimeout(run, 260);
