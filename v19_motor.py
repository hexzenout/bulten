...
# 27 LİGLİK TAM LİSTE (Ülke İsimleri ve Bayrak Kodlarıyla)
LIGLER = [
    ...
    {"k":"soccer_netherlands_eredivisie", "n":"EREDIVISIE", "t":"futbol", "f":"nl", "c":"HOLLANDA"},
    {"k":"soccer_portugal_primeira_liga", "n":"PRIMEIRA LIGA", "t":"futbol", "f":"pt", "c":"PORTEKİZ"},
    {"k":"soccer_brazil_campeonato", "n":"BRAZIL SERIE A", "t":"futbol", "f":"br", "c":"BREZİLYA"},
    {"k":"soccer_argentina_primera_division", "n":"ARGENTINA PRIMERA", "t":"futbol", "f":"ar", "c":"ARJANTİN"},
    ...
    {"k":"basketball_wnba", "n":"WNBA", "t":"basketbol", "f":"us", "c":"AMERİKA"},
    {"k":"basketball_ncaab", "n":"NCAA", "t":"basketbol", "f":"us", "c":"AMERİKA"},
    ...
    {"k":"basketball_italy_lega_a", "n":"LEGA A", "t":"basketbol", "f":"it", "c":"İTALYA"},
    {"k":"basketball_france_lnb_pro_a", "n":"LNB PRO A", "t":"basketbol", "f":"fr", "c":"FRANSA"},
    {"k":"basketball_germany_bbl", "n":"BBL", "t":"basketbol", "f":"de", "c":"ALMANYA"},
    {"k":"basketball_eurocup", "n":"EUROCUP", "t":"basketbol", "f":"eu", "c":"AVRUPA"},
    {"k":"basketball_champions_league", "n":"BCL", "t":"basketbol", "f":"eu", "c":"AVRUPA"},
    {"k":"basketball_vtb_united_league", "n":"VTB", "t":"basketbol", "f":"ru", "c":"RUSYA"}
]
...
class V19Master:
    ...
    def run(self):
        if not ODDS_API_POOL:
            # Şifre yoksa koruma
            self.results.append({"t": "futbol", "l": "SİSTEM UYARISI", "f": "un", "m": "API ŞİFRESİ EKSİK", "dt": datetime.now().strftime("%Y-%m-%d"), "tm": "00:00"})
